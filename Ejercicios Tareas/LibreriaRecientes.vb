Public Class LibreriaRecientes
    ...
    Private Sub btnVender_Click(sender As Object, e As EventArgs) Handles btnVender.Click
        ...
        If cmbClasicos.Text = "Espacios olvidados en la era de la globalización, Gustavo Hernández" Then
            total = cantidad * 800
            txtTotal.Text = total
        End If

        If cmbClasicos.Text = "Te espero en la próxima estación, Fernando Pardo Ruiz" Then
            total = cantidad * 1000
            txtTotal.Text = total
        End If

        If cmbClasicos.Text = "¿Dónde están los poetas cuando se les necesita?, Iván Robledo" Then
            total = cantidad * 1200
            txtTotal.Text = total
        End If

        If cmbClasicos.Text = "Las voces amarillas, Luis Veres" Then
            total = cantidad * 1400
            txtTotal.Text = total
        End If

        If cmbClasicos.Text = "Una historia en La Habana, Carlos Soriano" Then
            total = cantidad * 1600
            txtTotal.Text = total
        End If
